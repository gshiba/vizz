...
#########  kilograms.                                                                                        #####
#########  CPEG revisions Dec 14, 2016:                                                                      #####
#########    replaced look-up table wfawho2007.txt to add ages 122-229 mo (10-19y) to weight-for-age         #####
#########    LMS table extension based on CPEG re-analysis of WHO data (BMC Pediatrics, 2014: 14, 32)        #####
#########    For consistency, weight-for-age LMS for ages 0-121 mo were not revised.                         #####
#########    Search 'CPEG' to find other revisions to accomodate new age range.                               #####
#########    For questions, contact atul.sharma@umanitoba.ca                                                 #####      
##################################################################################################################
##################################################################################################################
...
for(i in 1:length(mat$age.mo)) {
# age.mo[i] < 121 in original file. Here extended CPEG Dec 14, 2016
...
########################################################################################################
#upper limit was 121 CPEG Dec 14, 2016
...
mat.out$oedema.vec1<-ifelse((!is.na(mat.out$age.mo) & (mat.out$age.mo<61 | mat.out$age.mo>=229))  | mat.out$oedema.vec=="NA","n",mat.out$oedema.vec)
...
# CPEG drop to retain all ages 5-19y in weight prevalence; Dec 14, 2016
